...
class Plant:
    def __init__(self, id, name, category, germination, seedling_stage, vegetative_growth, flowering_root_development, fruit_development, description):
        ...
        self.flowering_root_development = self.parse_int(flowering_root_development)
    ...
    def total_growth_time(self):
        stages = [self.germination, self.seedling_stage, self.vegetative_growth, self.flowering_root_development, self.fruit_development]
    ...
    def summary(self):
        return (f"Plant: {self.name}\n"
                ...
                f"Flowering/Root Development Time: {self.flowering_root_development or 'N/A'} days\n"
...
# Subclasses
class Legume(Plant):
    def __init__(self, name, category, germination, seedling_stage, vegetative_growth, flowering_root_development, description):
        super().__init__(name, category, germination, seedling_stage, vegetative_growth, flowering_root_development, None, description)
...
class FruitVegetable(Plant):
    def __init__(self, name, category, germination, seedling_stage, vegetative_growth, flowering_root_development, fruit_development, description):
        super().__init__(name, category, germination, seedling_stage, vegetative_growth, flowering_root_development, fruit_development, description)
...
def create_plant_instance(plant_data):
    ...
    return id, name, category, germination, seedling_stage, vegetative_growth, flowering_root_development, fruit_development, description
